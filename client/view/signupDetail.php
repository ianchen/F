...
echo "</tr>";
echo "<tr>";
echo "<td height=\"25\" align=\"left\" valign=\"middle\" bgcolor=\"#EDE9E4\" class=\"content_title\">人數:{$groupInfo["PRE_NUM"]}</td>";
echo "</tr>";
echo "<tr>";
echo "<td height=\"25\" align=\"left\" valign=\"middle\" bgcolor=\"#EDE9E4\" class=\"content_title\">團長:$captain</td>";
echo "</tr>";
echo "<tr>";
echo "<td height=\"25\" align=\"left\" valign=\"middle\" bgcolor=\"#EDE9E4\" class=\"content_title\">我的三個字:$myThreeWord</td>";
echo "</tr>";
echo "<tr>";
echo "<td height=\"25\" align=\"left\" valign=\"middle\" bgcolor=\"#EDE9E4\" class=\"content_title\">大家的三個字:";
for($i = 0; $i < count($othersThreeWord); $i++){
  echo $othersThreeWord[$i] . "&nbsp;&nbsp;&nbsp;";
}
echo "</td>";
echo "</tr>";
echo "<tr>";
